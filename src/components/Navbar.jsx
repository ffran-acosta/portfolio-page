  ...
  return (
    <div className='fixed w-full h-[80px] flex justify-between items-center px-4 border-b border-b-[#ef913e] bg-[#102649] text-white'>
      ...
      <ul className={!nav ? 'hidden' : 'absolute top-0 left-0 w-full h-screen bg-[#112b51] flex flex-col justify-center items-center'}>
        ...
        <li className='py-6 '>
          <a className='text-3xl hover:text-[#ef913e] duration-300' href="http://localhost:3000/CV-FRANCO-ACOSTA.pdf" download='CV.Franco.Acosta.pdf'>
            Resume
          </a>
        </li>
        {/* linkedin */}
        <li className='py-6'>
          <a className='text-3xl hover:text-[#ef913e] duration-300' target='blank' href="https://www.linkedin.com/in/ffran-acosta/">
            Linkedin
          </a>
        </li>
        {/* github */}
        <li className='py-6'>
          <a className='text-3xl hover:text-[#ef913e] duration-300' target='blank' href="https://github.com/ffran-acosta/">
            GitHub
          </a>
        </li>
        <li className='py-6 text-3xl hover:text-[#ef913e] duration-300'>
      ...
      <div className='hidden lg:flex fixed flex-col top-[35%] left-0'>
        <ul>
          ...
          <li className='w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-[#ef913e]'>
            <a className='flex justify-between items-center w-full text-white' href="http://localhost:3000/CV-FRANCO-ACOSTA.pdf" download='CV.Franco.Acosta.pdf'>
